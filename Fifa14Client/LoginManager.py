...
class LoginManager(object):
    ...
    def login(self):
        ...
        headers = {'Content-Type': 'application/json','Easw-Session-Data-Nucleus-Id':self.NUCID,'Content-Length':len(self.form_data),'X-UT-Route':'https://utas.s2.fut.ea.com:443'}
